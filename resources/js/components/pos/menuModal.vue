                ...
                <div class="modal-body">
                    <div class="row  gx-2" >
                        <div class="col-md-6 mb-2">
                            <button class="btn btn-dark btn-md w-100" @click="printLastOrderReceipt">
                                <i class="mdi mdi-printer font-size-20 me-1"></i>
                                Last Receipt
                            </button>
                        </div>
                        <div class="col-md-6  mb-2">
                            <button class="btn btn-secondary btn-md w-100" @click="printLastGiftReceipt">
                                <i class="mdi mdi-printer font-size-20 me-1"></i>
                                Gift Receipt
                            </button>
                        </div>
                        <div class="col-md-6 mb-2">
                            <button class="btn btn-info btn-md w-100" data-bs-toggle="modal" data-bs-target="#eodModal">
                                <i class="mdi mdi-cash-multiple font-size-20 me-1"></i>
                                Running Total
                            </button>
                        </div>
                        <div class="col-md-6 mb-2">
                            <button class="btn btn-success btn-md w-100" data-bs-toggle="modal"
                        ...
                        <div class="col-md-6 mb-2">
                            <button class="btn btn-danger btn-md w-100" data-bs-toggle="modal"
                               ...
                               <i class="mdi mdi-swap-horizontal font-size-20 me-1"></i> 
                                Inventory Transfer
                            </button>
                        </div>
                        <div class="col-md-6 mb-2 ">
                            <button class="btn btn-warning btn-md  w-100 text-nowrap" data-bs-toggle="modal"
                                data-bs-target="#transferInventoryHistoryModal">
                               <i class="mdi mdi-transfer-right font-size-20 me-1"></i>
